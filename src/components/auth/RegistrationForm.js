...
class RegistrationForm extends Component {
    ...
    render() {
        return (
            ...
            <form class="measure center" onSubmit={this.handleRegistration}>
                <fieldset class="ba b--transparent ph0 mh0">
                    <legend class="f4 fw6 ph0 mh0">Registration</legend>
                    <div class="mt3">
                        <label class="db fw6 lh-copy f6" htmlFor="inputUsername">Username</label>
                        <input
                ...
                <div class="">
                    <input class="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib" type="submit" value="Register"></input>
                </div>
      </form>
      </main>
        )
